...
var breakpoints = function breakpoints(props) {
  ...
  return Object.keys(props.breakpoints).map(function (id) {
    return props[id] && [css(_templateObject, media(parseBreakpoint(props.breakpoints[id])), generateStyles(props[id]), flex(props[id]))];
  });
};
    ...
    _temp = _class = function (_Component2) {
      ...
      createClass(_class, [{
        ...
        value: function render() {
          ...
          return React.createElement(WrappedComponent, _extends({}, this.props, props));
        }
...
var Base = function Base(element) {
  return styled(stripBoolean(element))(generateStyles);
};
 ...
 * are `Box` or `Bounds`.
 */
var Bounds = styled(Base("div"))(_templateObject$1, function (props) {
...
var Box = styled(Base("div"))(_templateObject$2, function (props) {
